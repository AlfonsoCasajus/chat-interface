<template>
	<nav
		class="z-10 w-full flex justify-between items-center px-4 py-2 bg-white dark:bg-gray-800 shadow-md"
	>
		...
		<span class="flex items-center">
			<button
				class="cursor-pointer bg-gray-200 dark:bg-gray-700 text-gray-800 dark:text-gray-200 p-2 rounded-full"
