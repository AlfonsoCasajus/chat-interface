export default [{
	...
	messages: [
		...
		{
			sender: { name: 'Nicolás', type: 'agent' },
			message: "Claro, ¿puedes proporcionarme el número de pedido, por favor?",
			time: "09:06"
		},
		{
			sender: { type: 'customer' },
	...
	messages: [
		...
		{
			sender: { name: 'Lucia', type: 'agent' },
			message: "Entiendo. Por favor, proporcióname el número de pedido y la nueva dirección.",
			time: "14:04"
		},
		{
			sender: { type: 'customer' },
			message: "El número de pedido es 987654321. La nueva dirección es Calle Falsa 123.",
			time: "14:05"
		},
		{
			sender: { name: 'Lucia', type: 'agent' },
			message: "Gracias. Hemos actualizado la dirección de entrega de tu pedido.",
			time: "14:07"
		},
		{
			sender: { type: 'customer' },
